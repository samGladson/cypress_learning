...
describe("Update Participant Details", () => {
  ...
  it("Amazon Search Finding", () => {
    ...
    cy.get("#twotabsearchtextbox")
      .type("{shift}goodies")
      .wait(10000)
      .get("div.s-suggestion.s-suggestion-ellipsis-direction span")
      .each(($val) => {
        cy.log($val.text());
  ...
  it("Handle opening new tab", () => {
    cy.visit(
      "https://barconvent-testing.stage.reds.rxweb-pre.com/en-gb/for-visitors/Products.html",
      { timeout: 10000 }
    )
      .get("button#onetrust-accept-btn-handler", { timeout: 10000 })
      .click();

    cy.contains("Gold product")
      .click()
      .get("button[data-dtm='productDetails_requestQuote']")
      .should("be.visible")
      .get("a[href*=contactForm]")
      .invoke("removeAttr", "target")
      .click({ force: true })
      .get("p.request-form-title")
      .should("have.text", "Request Formation", { timeout: 10000 });
  });
});
